...
const blogs = [
  {
    ...
    description:
      'Artificial Intelligence is revolutionizing the way websites are built and maintained. From automated code generation to intelligent design suggestions, AI-powered tools enhance developer productivity and streamline workflows. This article explores how AI is transforming the web development landscape, including real-world applications, tools like GitHub Copilot, and the future of AI-driven web design.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      'TypeScript has become a must-learn language for React developers. This guide walks you through the fundamentals of TypeScript, its advantages over JavaScript, how it improves code maintainability, and how to integrate it seamlessly into your React projects. We also provide best practices for error handling, interfaces, and type safety in modern applications.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description:
      'JavaScript frameworks continue to evolve, making development more streamlined and efficient. In this guide, we highlight the top JavaScript frameworks of 2025, including React, Vue, Svelte, and Astro. Learn about their pros, cons, and which one best suits your project requirements.',
  },
  {
    id: 9,
  ...
  },
  {
    ...
    image: '/images/blogs/article1.png',
    description:
      'Security is a top priority when building web applications. This article provides a comprehensive guide to securing Next.js applications, covering authentication, authorization, API security, data encryption, and best practices for preventing security vulnerabilities.',
  },
  {
    id: 11,
    ...
    image: '/images/blogs/article2.png',
    description:
      'Cloud computing has evolved significantly over the past decade. From traditional cloud services to serverless architectures and edge computing, this article explores the major shifts in cloud technology and what the future holds for businesses and developers.',
  },
  {
    id: 12,
    ...
    image: '/images/blogs/article3.png',
    description:
      'CSS Grid is one of the most powerful layout tools in web design. In this guide, we cover the fundamentals of CSS Grid, advanced layout techniques, and real-world examples to help you master modern web design.',
  },
  {
    id: 13,
    ...
    image: '/images/blogs/article4.png',
    description:
      'JavaScript continues to evolve with new ES2025 features. This article highlights the most exciting additions, including new syntax, improved performance, and how they can enhance modern web development.',
  },
  {
    id: 14,
    ...
    image: '/images/blogs/article5.png',
    description:
      'Website performance is crucial for user experience and SEO. Learn essential optimization techniques, such as code splitting, lazy loading, caching strategies, and image optimization, to make your website faster and more efficient.',
  },
  {
    id: 15,
    ...
    image: '/images/blogs/article6.png',
    description:
      'User experience (UX) design is constantly evolving. This article covers the best UX practices for 2025, including accessibility, user-centered design principles, and emerging trends in interface design.',
  },
]
            ...
            <div className="bg-white rounded-lg p-6 flex flex-col md:flex-row gap-6 items-center md:items-start">
              ...
              <div className="md:w-1/2 flex flex-col   gap-5">
                <Link href="" key={randomBlog.id}>
                  ...
                  <h4 className="text-lg text-gray-600 mt-2">{randomBlog.category}</h4>
              ...
              <Link href="" key={blog.id}>
                <div className="bg-white rounded-lg overflow-hidden shadow-lg p-5">
                  <Image
                    ...
                    width={400}
                    height={250}
                    className="w-full h-[250px]  shadow-sm rounded"
                  />
                  ...
                  <div className="p-5">
                    ...
                    <div>
                      {' '}
                      <p className="text-[#F1B729] text-sm mb-2 flex items-end gap-1">
                        <Image
