    ...
    <section className="max-w-7xl mx-auto mt-24 relative">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-8">
        ...
        <div className="relative sm:mt-16 self-center">
          ...
          <div className="w-[224px] h-[212px] lg:w-[448px] lg:h-[424px] rounded-tl-[200px] shadow-2xl shadow-black bg-[url(/images/about-us/rectangular-picture.png)] bg-cover bg-center bg-no-repeat z-10 md:w-[350px] sm:h-[330px] sm:rounded-tl-[150px]"></div>
          {/* under rectangle */}
