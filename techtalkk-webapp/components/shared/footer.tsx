...
import { LogoWhite, socialMediaLinks } from "@/components/icons/index"
...
export default function Footer() {
  return (
    <>
          ...
          <div className="my-5 flex flex-wrap justify-center gap-6 text-lg font-medium">
            {FooterLinks.map((link, index) => (
              <Link
                key={index}
                href={link.href}
                className="text-white font-sans hover:text-white/70 block duration-150"
              >
      ...
      <div className="text-white block text-center text-lg font-medium font-sans bg-[#5d16ec] w-full">
        {" "}
