...
import { LogoPink } from "@/components/ui/icons/index";
import { Button } from "@/components/ui/button";
import MenuIcon from "@/components/ui/home/Menu";
      ...
      <div className='hidden md:block'>
        <ul className='flex gap-8'>
          {NavLinks.map((link, index) => (
            <li key={index} className='text-xl font-medium transition-colors hover:text-primary'>
