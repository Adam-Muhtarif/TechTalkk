...
export default function JoinUs({ header, paragraph, buttonText }: Props) {
  return (
    <section className="relative overflow-x-hidden">
      <div className="relative max-w-7xl mx-auto z-1">
        <div className="absolute mt-8 px-4 sm:px-6 lg:px-8 inset-x-0 top-1.5 sm:mt-24 flex flex-col items-center lg:items-start lg:mx-0">
          ...
          <button className="bg-white text-[var(--primary-color)] text-2xl font-bold px-12 py-4 rounded-md shadow-card mt-8 hover:bg-white/70 duration-300 ease-in-out cursor-pointer">
            {buttonText}
          </button>
        </div>
      </div>
